...
public final class EventBusTests {
  ...
  public void runTestUnits() {
    ...
    eventBus.post(
        ...
        AbilityRegistry.getRegistry().getAbility("teleport"),
        new GamePlayer(null, null));
    eventBus.post(
        ArenaEvent.class,
        this.plugin.getArenaManager().getArenas().values().iterator().next(),
    ...
    eventBus.post(
        GadgetUseEvent.class,
        GadgetRegistry.getRegistry().getGadget("crash"),
        new GamePlayer(null, null));
    eventBus.post(
        TrapActivateEvent.class,
        GadgetRegistry.getRegistry().getGadget("crash"),
        new GamePlayer(null, null));
    eventBus.post(
        LobbyEvent.class,
        this.plugin.getLobbyManager().getLobbies().values().iterator().next(),
