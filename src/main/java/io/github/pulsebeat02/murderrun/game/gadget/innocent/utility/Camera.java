...
public final class Camera extends MurderGadget {
  ...
  private void handleGlowMurderer(
      final Murderer murderer, final Entity entity, final Collection<Innocent> innocents) {
  ...
  private void setLookDirection(final Murderer murderer, final Entity entity) {
