...
public final class FlashBang extends MurderGadget implements Listener {
  ...
  public FlashBang(final MurderRun plugin) {
    super(
        ...
        stack -> {
          ...
          if (meta == null) {
            throw new AssertionError("Failed to create flash bang!");
          }
          final PersistentDataContainer container = meta.getPersistentDataContainer();
          container.set(NamespacedKeys.FLASH_BANG, PersistentDataType.BOOLEAN, true);
        });
  ...
  public void onProjectileHitEvent(final ProjectileHitEvent event) {
    ...
    if (!ItemStackUtils.isFlashBang(stack)) {
      return;
    }
