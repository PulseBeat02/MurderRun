...
public final class KillerTracker extends SurvivorGadget {
  ...
  public KillerTracker() {
    super(
        ...
        GadgetSettings.KILLER_TRACKER_COST,
  ...
  public void onGadgetRightClick(
    ...
    final boolean destroy = count >= GadgetSettings.KILLER_TRACKER_USES;
    ...
    audience.playSound(GadgetSettings.KILLER_TRACKER_SOUND);
  }
