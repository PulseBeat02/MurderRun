...
public final class Decoy extends MurderGadget {
    ...
    public void customizeNPC(final Player player, final NPC npc) {
        ...
        npc.getOrAddTrait(Equipment.class).set(Equipment.EquipmentSlot.CHESTPLATE, inventory.getChestplate());
        npc.getOrAddTrait(Equipment.class).set(Equipment.EquipmentSlot.LEGGINGS, inventory.getLeggings());
