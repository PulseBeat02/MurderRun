...
public final class ArenaCommand implements AnnotationCommandFeature {
  ...
  public void setSpawn(final Player sender) {
    ...
    this.spawn = location;
    final Component message = ComponentUtils.createLocationComponent(Locale.ARENA_SPAWN, location);
    this.sendSuccessMessage(sender, message);
  }
  ...
  public void setFirstCorner(final Player sender) {
    ...
    final Component message =
        ComponentUtils.createLocationComponent(Locale.ARENA_FIRST_CORNER, location);
    this.sendSuccessMessage(sender, message);
  }
  ...
  public void setSecondCorner(final Player sender) {
    ...
    final Component message =
        ComponentUtils.createLocationComponent(Locale.ARENA_SECOND_CORNER, location);
    this.sendSuccessMessage(sender, message);
  }
}
