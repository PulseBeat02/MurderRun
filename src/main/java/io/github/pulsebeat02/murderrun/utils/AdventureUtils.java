...
public final class AdventureUtils {
    ...
    public static Component createLocationComponent(
            final LocaleParent.TriComponent<Sender, Integer, Integer, Integer> function, final Location location) {
    ...
    public static void playSoundForAllParticipantsAtLocation(
        ...
        final String key = getRandomKey(keys);
        final PlayerManager manager = game.getPlayerManager();
        manager.applyToAllParticipants(player -> player.playSound(origin, key, SoundCategory.MASTER, 1, 1));
    }
