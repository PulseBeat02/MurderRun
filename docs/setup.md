...
```{warning}
Murder Run only supports **Minecraft 26.1.2** as of right now. If you choose any other version, the plugin will **not**
start-up, and it will break. Make sure to choose **Paper 26.1.2** for now. Support for future versions will be added as
fast as possible.
```
...
on the TeamCity CI [here](https://ci.brandonli.me/repository/download/murderrun/.lastFinished/MurderRun-26.1.2-v1.0.0-all.jar),
